...
export const GLOBAL = {
  ...
  VOICENAME: {
    ...
    SUPPORTED: [
      {
        label: "zh-CN-XiaoxiaoMultilingualNeural-V2",
      ...
      {
        label: "en-US-AndrewMultilingualNeural-V2",
      ...
      {
        label: "de-DE-SeraphinaMultilingualNeural-V2",
      ...
      {
        label: "fr-FR-RemyMultilingualNeural-V2",
      ...
      {
        label: "fr-FR-VivienneMultilingualNeural-V2",
